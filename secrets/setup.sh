...
log "SOPS_AGE_KEY_FILE is already exported in the dotfiles zsh config."
log ""
log "Next steps:"
log "  1. Create your first encrypted env file:"
log "     sops ~/.secrets/env/global.env"
log ""
log "  2. Add entries in KEY=VALUE format, one per line."
...
log "     e. Sync the updated .sops.yaml and .env files to the new machine"
